...
namespace SignalRToDartInterface {
    public class GenerateRequest {
        ...
        public bool MapEnumToJsonAsString { get; set; }
        ...
        public GenerateRequest(
            ...
            List<string> skipMethodsToChildren = null,
            List<string> skipProperties = null,
            bool isSignalRHub = false,
            bool mapEnumFromJsonAsString = true
            ) {
            Type = type;
            MapEnumToJsonAsString = mapEnumFromJsonAsString;
